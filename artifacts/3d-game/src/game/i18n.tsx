...
const fr: I18nDictionary = {
  ...
  "app.ai.manual": "IA: Manuel",
  "app.ai.homing": "IA: Homing",
  "app.ai.homing_auto": "IA: Homing + auto",
  "app.title.menu": "Menu",
  "app.title.retry": "Retry",
  "app.title.add": "Ajouter",
  "app.killStar": "Étoile Kill",
  "app.killStarLost": "Étoile Kill perdue",
  "app.waveIntro.label": "Nouvelle vague",
  "app.waveIntro.number": "Vague {number}",
  ...
  "hud.waveNumber": "Vague {number} · {launched}/{max}",
  "hud.shoot": "▲ tirer",
  ...
  "menu.settings.subtitle": "Hormones et réglages experts",
  "menu.retry": "Retry",
  "menu.retry.subtitle": "Rejouer, boss ou niveau suivant",
  "menu.language": "Langue",
  "menu.language.subtitle": "Choisir français ou anglais",
...
const en: I18nDictionary = {
  ...
  "app.ai.manual": "AI: Manual",
  "app.ai.homing": "AI: Homing",
  "app.ai.homing_auto": "AI: Homing + auto",
  "app.title.menu": "Menu",
  "app.title.retry": "Retry",
  "app.title.add": "Add",
  "app.killStar": "Kill Star",
  "app.killStarLost": "Kill Star Lost",
  "app.waveIntro.label": "New wave",
  "app.waveIntro.number": "Wave {number}",
  ...
  "hud.waveNumber": "Wave {number} · {launched}/{max}",
  "hud.shoot": "▲ shoot",
  ...
  "menu.settings.subtitle": "Hormones and expert tuning",
  "menu.retry": "Retry",
  "menu.retry.subtitle": "Replay, boss, or next level",
  "menu.language": "Language",
  "menu.language.subtitle": "Choose French or English",
